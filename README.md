<div align="center">
  ...
  <img src="https://komarev.com/ghpvc/?username=equence&label=PROFILE+VIEWS&color=00FF41&style=flat-square" alt="Profile views" />
...
```c
struct Engineer {
    char name[16] = "equence";
    char role[32] = "Embedded Software Engineer";
    char company[32] = "SiFli Technologies";
    char music[24] = "LOONA / ARTMS";
    bool is_orbit = true;       // 🐰 LOONA's fan since pre-debut
};

void work() {
    while (1) {
        develop_firmware();     // C / Rust on MCU
        debug_hardware();       // SPI, I2C, UART
        listen_to_loona();      // productivity booster ⚡
        level_up();             // always growing
    }
}
```
...
## 🐱 **LOONA / ARTMS** — _This is my universe_

<div align="center">
  
  ![LOONA Green](https://img.shields.io/badge/LOONA-%2300FF41?style=for-the-badge&logo=kpop&logoColor=white)
...
<div align="center">
  ...
  ![Footer Divider](https://capsule-render.vercel.app/api?type=waving&color=00FF41&height=120&section=footer)

  **✨ From Seoul with ❤️ — equence**  
  _LOONA is the answer, what was the question?_ 💚
